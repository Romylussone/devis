$(document).ready(function(e)
{
    ...
    { 
      ...
      ListeEcolePanel.animate({opacity:0,display:"none"},500);
                  ...
                  {           
                    ...
                    var animtext1 = anime.timeline()
                                .add({
                                      ...
                                      complete : function()
                                      {
                                        textWrapper2.innerHTML = "Vous pouvez télécharger la brochure,visiter, ou encore écrire au Conseiller de l'école grâce au panneau Option situé en bas à droite.";
                                        textWrapper2.innerHTML = textWrapper2.textContent.replace(/\S/g, "<span class='letter' style='opacity:0;' >$&</span>");
    ...
    // Gestion des transitions et des actives button entre les écoles
    // $("#hassanII").click(function()
    // {
    //   switchScene(scenes[1]);
    //   $("#ESSEM").removeClass("current");
    ...
    $("#hall").click(function () 
    {
        ...
        ListeEcolePanel.animate({opacity:1,display:"default"},500);
        ...
        anime.timeline().add({ 
          ...
          complete: function()
          {
              textWrapper2.innerHTML = "En choisissant une école dans la liste à droite";
              textWrapper2.innerHTML = textWrapper2.textContent.replace(/\S/g, "<span class='letter' style='opacity:0;' >$&</span>");
              anime.timeline().add({ 
                        targets: '.anT2 .letter',
                        scale: [4,1],
                  ...
                  {           
                    ...
                    var animtext1 = anime.timeline()
                                .add({
                                      ...
                                      complete : function()
                                      {
                                          textWrapper2.innerHTML = "Vous pouvez consulter les écoles sur votre droite";
                                          textWrapper2.innerHTML = textWrapper2.textContent.replace(/\S/g, "<span class='letter' style='opacity:0;' >$&</span>");
                                          ...
                                          anime.timeline().add({ 
                                            ...
                                            complete:function()
                                            {
                                              textWrapper2.innerHTML = "Bonne visite à vous.";
                                              textWrapper2.innerHTML = textWrapper2.textContent.replace(/\S/g, "<span class='letter' style='opacity:0;' >$&</span>");
