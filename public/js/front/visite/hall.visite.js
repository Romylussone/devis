$(document).ready(function(e)
{
    ...
    btnConseilRdv.click(function(e)
    {
    ...
    $("#ListeEcoleCollapse button").on("click", function(){
      // console.log($(this));
      currentSchool = $(this);                                             
      conselle();
      ...
      currentEcoleID = $(this).attr('idecole');
      saveVisiteTrace();
    })
    ...
    //Au click sur le btn visiter l'ecole
    $("#btnConseilVisite").on("click", function(){
      
      //On appel la fonction qui va enregistrer les actions visiteurs dans la db
      saveVisiteTrace("visite-virtuelle");
    })

    //Au click sur le btn voir le site wen 
    $("#btnConseilHome").on("click", function()
    {
      //On appel la fonction qui va enregistrer les actions visiteurs dans la db
      saveVisiteTrace("site-web");
    })

    //Au click sur le btn télécharger brochure
    $("#btnConseilTelecharger").on("click", function(){

      //On appel la fonction qui va enregistrer les actions visiteurs dans la db
      saveVisiteTrace("brochure");
    })
    ...
    $("#hall").click(function () 
    {
        ...
        blockConseille.css("display","none");
        $("#video-presentation iframe").attr("src","");
        $("#video-presentation").hide("fast");
        $("#date-rdv").hide("fast");

        $(".anT2").css("display","none");
        var textWrapper1 = document.querySelector('.anT1');
        textWrapper1.innerHTML = "Vous pouvez en tout temps consulter les Conseillers de nos écoles partenaires";
        $(".anT1").show();
