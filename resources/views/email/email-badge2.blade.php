            ...
            <tr>
                  <td style="text-align: center;">
                      <div class="text-author">
                          <h2 class="name" style="color:white;">{{$nomVisiteur}}</h2>
                          <h4 style="color:white;" >Email : {{$emailVisiteur}}</h4>
                          <h4 style="color:white;" >Tel : {{$numeroVisiteur}}</h4>
                       </div>
                  </td>
                </tr>
        </table>
                  ...
                  <div class="col-md-5 offset-lg-1">
                           <div class="row mt-2">
                              ...
                              <div class="col-sm-5">
                                ...
                                </i> <u>Nom & Prénoms</u></div>
                              </div>
                              <div class="col-sm-7">
                                 <div class="pb-2" >{{$nomVisiteur}} </div>
                              </div>
                              <div class="col-sm-5">
                                 <div class="pb-2 fw-bolder"><i class="far fa-envelope pe-2 text-muted" style="width:24px;opacity:0.85;"></i> <u>Email</u></div>
                              </div>
                              <div class="col-sm-7">
                                 <div class="pb-2">{{$emailVisiteur}}</a></div>
                              </div>
                              <div class="col-sm-5">
                                 <div class="pb-2 fw-bolder"><i class="fas fa-phone pe-2 text-muted" style="width:24px;opacity:0.85;"></i> <u>Telephone</u></div>
                              </div>
                              <div class="col-sm-7">
